...
describe('Validate TS configs', () => {
  it('Validate adorkable-wang-eslint-config/typescript', async () => {
  ...
  it('Validate adorkable-wang-eslint-config/typescript/vue', async () => {
  ...
  it('Validate adorkable-wang-eslint-config/essential/typescript', async () => {
  ...
  it('Validate adorkable-wang-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate adorkable-wang-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate adorkable-wang-eslint-config/typescript/node', async () => {
