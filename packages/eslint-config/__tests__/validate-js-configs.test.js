...
describe('Validate JS configs', () => {
  it('Validate adorkable-wang-eslint-config', async () => {
  ...
  it('Validate adorkable-wang-eslint-config/es5', async () => {
  ...
  it('Validate adorkable-wang-eslint-config/vue', async () => {
  ...
  it('Validate adorkable-wang-eslint-config/essential', async () => {
  ...
  it('Validate adorkable-wang-eslint-config/essential/es5', async () => {
  ...
  it('Validate adorkable-wang-eslint-config/essential/react', async () => {
  ...
  it('Validate adorkable-wang-eslint-config/essential/vue', async () => {
  ...
  it('Validate adorkable-wang-eslint-config/node', async () => {
