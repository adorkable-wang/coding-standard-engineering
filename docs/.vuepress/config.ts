...
export default defineConfig4CustomTheme({
  locales: {
    '/': {
      lang: 'zh-CN',
      title: '前端编码规范',
      description: 'adorkable-wang 前端编码规范',
    },
  },
  base: '/adorkable-wang/',
  ...
  themeConfig: {
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'adorkable-wang-eslint-plugin', link: '/npm/eslint-plugin.md' },
        ],
      },
      {
        text: '脚手架',
    ...
    sidebar: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: 'adorkable-wang-eslint-plugin', path: '/npm/eslint-plugin.md' },
        ],
      },
      {
        title: '脚手架',
    ...
    logo: '/img/logo.png',
    repo: 'adorkable-wang/coding-standard-engineering',
    searchMaxSuggestions: 10,
    docsDir: 'docs',
    footer: {
      createYear: 2023,
      copyrightInfo:
        'encode studio | <a href="https://github.com/adorkable-wang/coding-standard-engineering" target="_blank">github</a>',
    },
  },
